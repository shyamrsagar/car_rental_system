...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
   ...
   <a class="navbar-brand" href="<?php echo base_url();?>index.php"><img src="<?php echo base_url();?>images/logo.jpg" alt="Cents2Acres" height="70" width="120"/></a>
    </div>
...
<div class="jumbotron text-center" style="background-image:url(<?php echo base_url();?>images/house.jpg); ">
  <h1>Cents2Acres</h1>
  <p>Search for land</p>
...
?>
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><?php echo $t["description"];?></div>
      </div>
    </div>
<?php
}
